...
# Paths
MD_PATH = r'C:\Users\magic\.gemini\antigravity\brain\c371ebd9-48cd-4a01-be5c-3b40b7433da7\erickson_situational_best_10.md'
DATA_DIR = r'C:\Users\magic\Downloads\erickson_data'
TXT_PATH = os.path.join(DATA_DIR, 'erickson_situational_best_10.txt')
HTML_PATH = os.path.join(DATA_DIR, 'temp_report.html')
PDF_PATH = os.path.join(DATA_DIR, 'erickson_situational_best_10.pdf')
...
def convert():
    ...
    # 1. Save as TXT
    print(f"Saving to TXT: {TXT_PATH}")
